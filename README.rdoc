...
* AR model, spec and migration for a GroupEvent that would meet the needs of the description above. 
* API api controller and spec to support JSON request/responses to manage these GroupEvents. 
